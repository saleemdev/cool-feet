...
const Footer = () => {
  return (
    <>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 col-sm-12">
              <h2>About Us</h2>
              <p>Cool Feet is a leading provider of .......</p>
              <p>Some short description of mission here...</p>
            </div>
            <div class="col-md-4 col-sm-12">
              <h2>Useful Links</h2>
      ...
      <div class="copy">
        <div class="container">
          <a href="https://salimcv.netlify.app/">
            2022 &copy; All Rights Reserved | Designed and Developed by Zaha IT
            Consulting Limited
          </a>
